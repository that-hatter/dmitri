...
var names = ["info", "?", "basic"];
var desc = "Displays basic information regarding an element including a summary and an image.";
var usage = ["ELEMENT", "Here, `ELEMENT` can be the name, symbol, or atomic number of your desired element. Both name and symbol are not case-sensitive."];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (args.length < 1)
                    return [2 /*return*/];
                element = util.getElementByQuery(args[0]);
